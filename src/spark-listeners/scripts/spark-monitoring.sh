...
export LOG_ANALYTICS_WORKSPACE_ID=de187922-e7cf-482c-a284-e772abdbd219
export LOG_ANALYTICS_WORKSPACE_KEY=VILJUbFn1BLSwopesiwVpXqfWC2kHbyzxvevSnAJZaYF8oQ0AGO3FSJ1vyIKb17EmWywzL2wJXv+ToK2hMTCug==
export AZ_SUBSCRIPTION_ID=4a9ef912-a2e9-4795-b0ce-55b456fd2f6e
export AZ_RSRC_GRP_NAME=myDatabricks
export AZ_RSRC_PROV_NAMESPACE=Microsoft.Databricks
export AZ_RSRC_TYPE=workspaces
export AZ_RSRC_NAME=myDatabricks1
